...
// event.bind(document.getElementById('upload'), 'change',
//     function(e) {
//         var file = e.target.files[0];
//         browserMD5File(file,
//             function(err, md5) {
//                 //setfile(err, md5, e.target.files[0].size);
//                 //alert(md5 + ' ' + e.target.file[0].size);
//                 //document.getElementById('text').innerHTML = md5 + ' Size:' + e.target.files[0].size;
//                 alert(md5);
//             });
//     });